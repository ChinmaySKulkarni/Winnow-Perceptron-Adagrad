% This function implements the winnow with margin algorithm. 
% It is run over different training sets and it returns a vector representing the number of mistakes.
%
% Input:
% x: k-by-n matrix,
...
function [mistake_vector] = winnow_margin_find_mistakes(x,y,param,margin)
    [k,n] = size(x);
