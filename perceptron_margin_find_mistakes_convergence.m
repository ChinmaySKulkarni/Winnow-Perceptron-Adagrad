...
% It is run over different training sets and it returns the total number of mistakes reached till the point when a
...
function [mistakes] = perceptron_margin_find_mistakes_convergence(x,y,r)
    [k,n] = size(x);
